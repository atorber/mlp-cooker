...
市面上的机器学习平台往往功能繁复、操作冗长，对于需要快速试错和实验的科研、工程用户来说，并不友好。

我们希望拥有的是一个简单、开箱即用的平台，能让我专注在模型的构建和实验，而不是被运维、配置、琐碎的接口调用所困扰。

## MPL-COOKER 的愿景

MPL-COOKER 针对这一痛点，力求以极简的设计理念，为用户提供清晰的操作流程和开源的可定制空间。
